...
execute if score kill um.dummy matches 1 run loot give @p loot undermagic:items/in_the_chamber_of_madness
execute if score kill um.dummy matches 1 run loot give @p loot undermagic:items/reign_of_the_corrupt
