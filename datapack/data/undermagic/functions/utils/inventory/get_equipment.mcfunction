...
execute in minecraft:overworld unless data entity @s SelectedItem run item block -29999998 0 1601 container.0 replace minecraft:barrier{um_gui:1b}
...
execute in minecraft:overworld run data modify block -29999998 0 1601 Items append from storage undermagic:common var
execute in minecraft:overworld unless data entity @s Inventory[{Slot:-106b}] run item block -29999998 0 1601 container.1 replace minecraft:barrier{um_gui:1b}
...
execute in minecraft:overworld run data modify block -29999998 0 1601 Items append from storage undermagic:common var
execute in minecraft:overworld unless data entity @s Inventory[{Slot:100b}] run item block -29999998 0 1601 container.2 replace minecraft:leather_boots{um_gui:1b}
...
execute in minecraft:overworld run data modify block -29999998 0 1601 Items append from storage undermagic:common var
execute in minecraft:overworld unless data entity @s Inventory[{Slot:101b}] run item block -29999998 0 1601 container.3 replace minecraft:leather_leggings{um_gui:1b}
...
execute in minecraft:overworld run data modify block -29999998 0 1601 Items append from storage undermagic:common var
execute in minecraft:overworld unless data entity @s Inventory[{Slot:102b}] run item block -29999998 0 1601 container.4 replace minecraft:leather_chestplate{um_gui:1b}
...
execute in minecraft:overworld run data modify block -29999998 0 1601 Items append from storage undermagic:common var
execute in minecraft:overworld unless data entity @s Inventory[{Slot:103b}] run item block -29999998 0 1601 container.5 replace minecraft:barrier{um_gui:1b}
