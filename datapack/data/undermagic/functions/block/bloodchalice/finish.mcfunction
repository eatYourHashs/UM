...
execute if score @s um.dummy matches 300.. if data storage undermagic:common list[{Count:4b,id:"minecraft:nether_star"}] if data storage undermagic:common list[{Count:2b,id:"minecraft:golden_apple"}] if data storage undermagic:common list[{Count:4b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:2b,id:"minecraft:gold_block"}] as @p at @s run function undermagic:infusions/tolerance
execute if score @s um.dummy matches 300.. if data storage undermagic:common list[{Count:4b,id:"minecraft:nether_star"}] if data storage undermagic:common list[{Count:2b,id:"minecraft:golden_apple"}] if data storage undermagic:common list[{Count:4b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:2b,id:"minecraft:gold_block"}] run scoreboard players remove @s um.dummy 300
...
#Nether Star Dupe
execute if score @s um.dummy matches 100.. if data storage undermagic:common list[{Count:1b,id:"minecraft:gold_block"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:emerald_block"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:diamond_block"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:nether_star"}] run give @p minecraft:nether_star 2
execute if score @s um.dummy matches 100.. if data storage undermagic:common list[{Count:1b,id:"minecraft:gold_block"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:emerald_block"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:diamond_block"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:nether_star"}] run scoreboard players remove @s um.dummy 100
