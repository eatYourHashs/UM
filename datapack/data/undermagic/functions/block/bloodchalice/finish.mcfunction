...
execute if score @s um.dummy matches 500.. if data storage undermagic:common list[{Count:1b,id:"minecraft:netherite_ingot"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"bloody_edge_3"}}] if data storage undermagic:common list[{Count:5b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ghast_tear"}] run loot spawn ~ ~1 ~ loot undermagic:items/bloody_edge_4
execute if score @s um.dummy matches 500.. if data storage undermagic:common list[{Count:1b,id:"minecraft:netherite_ingot"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"bloody_edge_3"}}] if data storage undermagic:common list[{Count:5b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ghast_tear"}] run scoreboard players remove @s um.dummy 500
...
execute if score @s um.dummy matches 1000.. if data storage undermagic:common list[{Count:2b,id:"minecraft:netherite_ingot"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"carnage_3"}}] if data storage undermagic:common list[{Count:10b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:10b,tag:{um_id:"Bloodstone"}}] run loot spawn ~ ~1 ~ loot undermagic:items/carnage_4
execute if score @s um.dummy matches 1000.. if data storage undermagic:common list[{Count:2b,id:"minecraft:netherite_ingot"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"carnage_3"}}] if data storage undermagic:common list[{Count:10b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:10b,tag:{um_id:"Bloodstone"}}] run scoreboard players remove @s um.dummy 1000
...
execute if score @s um.dummy matches 250.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_helmet",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] run loot spawn ~ ~1 ~ loot undermagic:items/bloodstained_armor
execute if score @s um.dummy matches 250.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_helmet",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] run scoreboard players remove @s um.dummy 250
execute if score @s um.dummy matches 250.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_chestplate",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] run loot spawn ~ ~1 ~ loot undermagic:items/bloodstained_armor
execute if score @s um.dummy matches 250.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_chestplate",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] run scoreboard players remove @s um.dummy 250
execute if score @s um.dummy matches 250.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_leggings",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] run loot spawn ~ ~1 ~ loot undermagic:items/bloodstained_armor
execute if score @s um.dummy matches 250.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_leggings",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] run scoreboard players remove @s um.dummy 250
execute if score @s um.dummy matches 250.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_boots",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] run loot spawn ~ ~1 ~ loot undermagic:items/bloodstained_armor
execute if score @s um.dummy matches 250.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_boots",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] run scoreboard players remove @s um.dummy 250
...
execute if score @s um.dummy matches 300.. if data storage undermagic:common list[{Count:1b,tag:{um_id:"nether_shard"}}] if data storage undermagic:common list[{Count:2b,id:"minecraft:golden_apple"}] if data storage undermagic:common list[{Count:4b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:2b,id:"minecraft:gold_block"}] as @p at @s run function undermagic:infusions/tolerance
execute if score @s um.dummy matches 300.. if data storage undermagic:common list[{Count:1b,tag:{um_id:"nether_shard"}}] if data storage undermagic:common list[{Count:2b,id:"minecraft:golden_apple"}] if data storage undermagic:common list[{Count:4b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:2b,id:"minecraft:gold_block"}] run scoreboard players remove @s um.dummy 300
execute if score @s um.dummy matches 400.. if data storage undermagic:common list[{Count:2b,id:"minecraft:purpur_block"}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ender_pearl"}] if data storage undermagic:common list[{Count:6b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ender_pearl"}] as @p at @s run function undermagic:infusions/enderlord
execute if score @s um.dummy matches 400.. if data storage undermagic:common list[{Count:2b,id:"minecraft:purpur_block"}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ender_pearl"}] if data storage undermagic:common list[{Count:6b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ender_pearl"}] run scoreboard players remove @s um.dummy 400
...
execute if score @s um.dummy matches 500.. if data storage undermagic:common list[{Count:1b,id:"minecraft:netherite_ingot"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"blood_rain_staff_3"}}] if data storage undermagic:common list[{Count:5b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ghast_tear"}] run loot spawn ~ ~1 ~ loot undermagic:items/blood_rain_staff_4
execute if score @s um.dummy matches 500.. if data storage undermagic:common list[{Count:1b,id:"minecraft:netherite_ingot"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"blood_rain_staff_3"}}] if data storage undermagic:common list[{Count:5b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ghast_tear"}] run scoreboard players remove @s um.dummy 500

#Puncture
execute if score @s um.dummy matches 10.. if data storage undermagic:common list[{Count:4b,id:"minecraft:red_dye"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:crossbow"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:golden_apple"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:blaze_powder"}] run loot spawn ~ ~1 ~ loot undermagic:items/puncture_1
execute if score @s um.dummy matches 10.. if data storage undermagic:common list[{Count:4b,id:"minecraft:red_dye"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:crossbow"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:golden_apple"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:blaze_powder"}] run scoreboard players remove @s um.dummy 10
execute if score @s um.dummy matches 50.. if data storage undermagic:common list[{Count:1b,id:"minecraft:glowstone"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"puncture_1"}}] if data storage undermagic:common list[{Count:1b,id:"minecraft:ender_eye"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:blaze_rod"}] run loot spawn ~ ~1 ~ loot undermagic:items/puncture_2
execute if score @s um.dummy matches 50.. if data storage undermagic:common list[{Count:1b,id:"minecraft:glowstone"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"puncture_1"}}] if data storage undermagic:common list[{Count:1b,id:"minecraft:ender_eye"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:blaze_rod"}] run scoreboard players remove @s um.dummy 50
execute if score @s um.dummy matches 250.. if data storage undermagic:common list[{Count:1b,id:"minecraft:dragon_breath"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"puncture_2"}}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:golden_sword"}] run loot spawn ~ ~1 ~ loot undermagic:items/puncture_3
execute if score @s um.dummy matches 250.. if data storage undermagic:common list[{Count:1b,id:"minecraft:dragon_breath"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"puncture_2"}}] if data storage undermagic:common list[{Count:1b,id:"minecraft:enchanted_golden_apple"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:golden_sword"}] run scoreboard players remove @s um.dummy 250
execute if score @s um.dummy matches 500.. if data storage undermagic:common list[{Count:1b,id:"minecraft:netherite_ingot"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"puncture_3"}}] if data storage undermagic:common list[{Count:5b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ghast_tear"}] run loot spawn ~ ~1 ~ loot undermagic:items/puncture_4
execute if score @s um.dummy matches 500.. if data storage undermagic:common list[{Count:1b,id:"minecraft:netherite_ingot"}] if data storage undermagic:common list[{Count:1b,tag:{um_id:"puncture_3"}}] if data storage undermagic:common list[{Count:5b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ghast_tear"}] run scoreboard players remove @s um.dummy 500
