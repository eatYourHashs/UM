...
execute if score @s um.dummy matches 300.. if data storage undermagic:common list[{Count:1b,tag:{um_id:"nether_shard"}}] if data storage undermagic:common list[{Count:2b,id:"minecraft:golden_apple"}] if data storage undermagic:common list[{Count:4b,tag:{um_id:"cbe"}}] if data storage undermagic:common list[{Count:2b,id:"minecraft:gold_block"}] run scoreboard players add @s um.dummy_two 1
execute if score @s um.dummy matches 400.. if data storage undermagic:common list[{Count:4b,id:"minecraft:ender_pearl"}] if data storage undermagic:common list[{Count:4b,id:"minecraft:ender_pearl"}] if data storage undermagic:common list[{Count:2b,id:"minecraft:purpur_block"}] if data storage undermagic:common list[{Count:6b,tag:{um_id:"cbe"}}] run scoreboard players add @s um.dummy_two 1
