...
execute if data storage undermagic:common obj{id:"minecraft:nautilus_shell"} run scoreboard players set temp um.dummy 1
...
execute if data storage undermagic:common obj.tag{um_id:"pit_lord_heart"} run scoreboard players set temp um.dummy 1
execute if data storage undermagic:common obj.tag{um_id:"sanguine_eye"} run scoreboard players set temp um.dummy 1
