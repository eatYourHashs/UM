...
execute if score @s um.dummy matches 10.. if data storage undermagic:common list[{Count:4b,id:"minecraft:red_dye"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:crossbow"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:golden_apple"}] if data storage undermagic:common list[{Count:1b,id:"minecraft:blaze_powder"}] run scoreboard players add @s um.dummy_two 1
