...
execute align xyz positioned ~0.5 ~ ~0.5 run summon armor_stand ~ ~0.5 ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["um.entity","um.bloodchalice"],ArmorItems:[{},{},{},{}]}
tp @p
