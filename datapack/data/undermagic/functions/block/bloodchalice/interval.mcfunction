...
execute if score @s um.dummy_two matches 0 positioned ~3 ~ ~3 if entity @e[distance=..1,tag=um_blood_monolith] at @s positioned ~3 ~ ~-3 if entity @e[distance=..1,tag=um_blood_monolith] at @s positioned ~-3 ~ ~3 if entity @e[distance=..1,tag=um_blood_monolith] at @s positioned ~-3 ~ ~-3 if entity @e[distance=..1,tag=um_blood_monolith] at @s run function undermagic:block/bloodchalice/recipes_monolith
