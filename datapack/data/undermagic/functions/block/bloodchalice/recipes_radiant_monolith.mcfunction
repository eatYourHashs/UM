...
execute if score @s um.dummy matches 75.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_helmet",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:diamond_block"}] run scoreboard players add @s um.dummy_two 1
execute if score @s um.dummy matches 75.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_chestplate",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:diamond_block"}] run scoreboard players add @s um.dummy_two 1
execute if score @s um.dummy matches 75.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_leggings",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:diamond_block"}] run scoreboard players add @s um.dummy_two 1
execute if score @s um.dummy matches 75.. if score temp um.dummy matches 2 if data storage undermagic:common list[{id:"minecraft:chainmail_boots",Count:1b}] if data storage undermagic:common list[{Count:1b,id:"minecraft:diamond_block"}] run scoreboard players add @s um.dummy_two 1
