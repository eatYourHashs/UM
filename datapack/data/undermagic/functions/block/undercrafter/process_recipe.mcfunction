...
execute store result block ~ ~ ~ Items[{Slot:4b}].Count byte 1 run data get block ~ ~ ~ Items[{Slot:4b}].Count 0.999
...
execute store result block ~ ~ ~ Items[{Slot:13b}].Count byte 1 run data get block ~ ~ ~ Items[{Slot:13b}].Count 0.999
