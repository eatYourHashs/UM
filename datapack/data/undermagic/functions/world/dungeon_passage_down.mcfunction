...
execute unless score stop um.dummy matches 1 if score rand um.dummy matches 50..90 positioned ^ ^-3 ^9 unless entity @e[tag=um_dungeon_intersection,distance=..24] unless score succ um.dummy matches 8.. run function undermagic:dungeon_intersection
execute unless score stop um.dummy matches 1 if score rand um.dummy matches 50..90 positioned ^ ^-3 ^9 unless entity @e[tag=um_dungeon_intersection,distance=..24] if score succ um.dummy matches 8.. run function undermagic:dungeon_passage
