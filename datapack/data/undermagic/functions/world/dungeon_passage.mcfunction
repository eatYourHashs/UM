...
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 66..70 positioned ^ ^ ^9 if score death_spawned um.dummy matches 0 run function undermagic:world/dungeon_death_room_mark
...
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 71..75 positioned ^ ^ ^9 if score destruction_spawned um.dummy matches 0 run function undermagic:world/dungeon_destruction_room_mark
...
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 91..100 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_spawn,distance=..128] if score shade_arena_spawned matches 1 run fill ^-1 ^ ^1 ^1 ^2 ^1 polished_blackstone_bricks 
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 91..100 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_spawn,distance=..128] unless entity @e[tag=um.shadesull_arena] if score destruction_spawned um.dummy matches 1 if score death_spawned um.dummy matches 1 run function undermagic:world/shadesull_arena_mark
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 91..100 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_spawn,distance=..128] unless entity @e[tag=um.shadesull_arena] if score destruction_spawned um.dummy matches 0 if score death_spawned um.dummy matches 1 run function undermagic:world/dungeon_passage_mark
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 91..100 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_spawn,distance=..128] unless entity @e[tag=um.shadesull_arena] if score destruction_spawned um.dummy matches 1 if score death_spawned um.dummy matches 0 run function undermagic:world/dungeon_passage_mark
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 91..100 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_spawn,distance=..128] unless entity @e[tag=um.shadesull_arena] if score destruction_spawned um.dummy matches 0 if score death_spawned um.dummy matches 0 run function undermagic:world/dungeon_passage_mark
