...
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 50..75 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_intersection,distance=..24] unless score succ um.dummy matches 8.. run function undermagic:world/dungeon_intersection_mark
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 50..75 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_intersection,distance=..24] if score succ um.dummy matches 8.. run function undermagic:world/dungeon_passage_mark
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 50..75 positioned ^ ^ ^9 if entity @e[tag=um.dungeon_intersection,distance=..24] unless score succ um.dummy matches 8.. run function undermagic:world/dungeon_passage_mark
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 50..75 positioned ^ ^ ^9 if entity @e[tag=um.dungeon_intersection,distance=..24] if score succ um.dummy matches 8.. run function undermagic:world/dungeon_passage_mark
...
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 91..100 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_spawn,distance=..128] if entity @e[tag=um.shadesull_arena] run fill ^-1 ^ ^1 ^1 ^2 ^1 polished_blackstone_bricks 
execute unless score stop um.dummy matches 1 if score $math.out_0 um.dummy matches 91..100 positioned ^ ^ ^9 unless entity @e[tag=um.dungeon_spawn,distance=..128] unless entity @e[tag=um.shadesull_arena] run function undermagic:world/shadesull_arena_mark
