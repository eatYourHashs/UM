...
scoreboard players operation spiretop_rand um.dummy = $math.out_0 um.dummy
scoreboard players add spiretop_rand um.dummy 1
...
execute if score spire_height um.dummy matches 1.. positioned ~ ~10 ~ run function undermagic:world/abyss/structures/spire_step
