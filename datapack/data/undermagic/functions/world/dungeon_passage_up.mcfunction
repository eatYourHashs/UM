...
execute unless score stop um.dummy matches 1 run fill ^-1 ^ ^1 ^1 ^5 ^9 minecraft:air
...
execute unless score stop um.dummy matches 1 run fill ^-1 ^2 ^7 ^1 ^2 ^9 minecraft:polished_blackstone_bricks
execute unless score stop um.dummy matches 1 run setblock ^ ^6 ^5 soul_lantern[hanging=true]
