...
execute as @e[tag=!global.ignore,scores={um.invuln=10..},distance=..4,tag=!um.wielder] run function undermagic:utils/damage_entity
execute as @e[tag=!global.ignore,scores={um.invuln=10..},distance=..4,tag=!um.wielder] at @s run particle minecraft:smoke ~ ~ ~ 0 0 0 0.1 20
