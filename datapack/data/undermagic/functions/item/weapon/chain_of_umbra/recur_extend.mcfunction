...
execute if score @s um.dummy matches 10.. as @e[tag=!global.ignore,scores={um.invuln=10..},distance=..1,tag=!um_wielder] run function undermagic:utils/damage_entity
