execute if score temp um.dummy matches 2.. run particle minecraft:dust 0.749 1 0 1
tp ~ ~ ~
...
execute if score temp um.dummy < @s um.dummy positioned ^ ^ ^1 run function undermagic:item/weapon/caustic_lash/recur_extend
