summon fireball ^ ^1 ^4 {direction:[0.0d,0.0d,0.0d],Tags:["um_entity","um_fireshot","um_projectile"],ExplosionPower:1b}
...
scoreboard players set @s um.orb_cooldown 40
...
execute as @e[sort=nearest,limit=1,tag=um_fireshot] at @s run tp ^ ^ ^1.6
