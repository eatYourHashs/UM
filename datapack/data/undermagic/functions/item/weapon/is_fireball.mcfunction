summon fireball ^ ^1 ^4 {direction:[0.0d,0.0d,0.0d],Tags:["um.entity","um.fireshot","um.projectile"],ExplosionPower:2b}
...
execute as @e[sort=nearest,limit=1,tag=um.fireshot] at @s run tp ^ ^ ^2.5
