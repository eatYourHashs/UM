execute if score temp um.dummy matches 2.. run particle minecraft:electric_spark
execute if score temp um.dummy matches 2.. if predicate undermagic:probability/0.03 run particle minecraft:flame
tp ~ ~ ~
...
execute if score @s um.dummy matches 10.. as @e[tag=!global.ignore,scores={um.invuln=10..},distance=..1.5,tag=!um.wielder] run function undermagic:utils/damage_entity
execute if score temp um.dummy < @s um.dummy positioned ^ ^ ^1.5 run function undermagic:item/weapon/lashes_of_light/recur_extend
