...
execute if data entity @s Inventory[{Slot:-106b}].tag{um_id:"augis_oblivia"} run scoreboard players add @s um.mana 15
execute if data entity @s Inventory[{Slot:-106b}].tag{um_id:"augis_oblivia"} run scoreboard players remove @s um.mana_used 10
