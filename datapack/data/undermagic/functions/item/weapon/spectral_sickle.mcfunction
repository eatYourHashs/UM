...
execute unless data entity @s Inventory[{Slot:-106b}].tag{um_id:"oblivion_matrix"} positioned ~ ~1.3 ~ run summon armor_stand ^ ^ ^1 {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.projectile","um.spectral_sickle"]}
