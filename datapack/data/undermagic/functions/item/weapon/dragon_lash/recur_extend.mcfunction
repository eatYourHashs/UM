execute if score temp um.dummy matches 2.. run particle dragon_breath
tp ~ ~ ~
...
execute if score temp um.dummy < @s um.dummy positioned ^ ^ ^1 run function undermagic:item/weapon/dragon_lash/recur_extend
