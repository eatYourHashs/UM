...
execute if score @s um.ak_count matches 200 run attribute @s minecraft:generic.attack_damage modifier add e18c5451-786b-4fd9-837a-49ac5a93dc9c abyss_knight 1 multiply_base
