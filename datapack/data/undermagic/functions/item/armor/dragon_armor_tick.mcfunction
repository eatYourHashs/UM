...
execute if score @s um.drag_animate matches 2 run replaceitem entity @e[tag=um.dragon_wings,distance=..10,sort=nearest,limit=1] armor.head minecraft:carrot_on_a_stick{CustomModelData:420090}
execute if score @s um.drag_animate matches 4 run replaceitem entity @e[tag=um.dragon_wings,distance=..10,sort=nearest,limit=1] armor.head minecraft:carrot_on_a_stick{CustomModelData:420091}
execute if score @s um.drag_animate matches 6 run replaceitem entity @e[tag=um.dragon_wings,distance=..10,sort=nearest,limit=1] armor.head minecraft:carrot_on_a_stick{CustomModelData:420092}
execute if score @s um.drag_animate matches 8 run replaceitem entity @e[tag=um.dragon_wings,distance=..10,sort=nearest,limit=1] armor.head minecraft:carrot_on_a_stick{CustomModelData:420091}
