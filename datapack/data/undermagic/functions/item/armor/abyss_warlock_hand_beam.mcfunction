...
effect give @e[distance=..2,type=!#undermagic:undead,scores={um.aw_mark=1..}] instant_damage 1 2 true
effect give @e[distance=..2,type=#undermagic:undead,scores={um.aw_mark=1..}] instant_health 1 2 true
