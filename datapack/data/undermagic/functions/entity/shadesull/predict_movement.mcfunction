...
execute as @e[tag=um_move_predict,limit=1,sort=nearest] store result entity @s Pos[0] double 0.001 run scoreboard players get x um.dummy
execute as @e[tag=um_move_predict,limit=1,sort=nearest] store result entity @s Pos[1] double 0.001 run scoreboard players get y um.dummy
execute as @e[tag=um_move_predict,limit=1,sort=nearest] store result entity @s Pos[2] double 0.001 run scoreboard players get z um.dummy