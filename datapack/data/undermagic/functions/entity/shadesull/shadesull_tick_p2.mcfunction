...
execute if score @s um.music matches 2020 run playsound um:music.shadesull_p2 master @a[distance=..50] ~ ~ ~ 0.5 1 0.5
execute if score @s um.music matches 2020.. run scoreboard players set @s um.music 0
