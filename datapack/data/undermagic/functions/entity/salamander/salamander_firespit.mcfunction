summon fireball ^ ^1 ^4 {direction:[0.01d,0.01d,0.01d],Tags:["um.entity","um.fireshot","um.projectile"],ExplosionPower:1b}
execute as @e[sort=nearest,limit=1,tag=um.fireshot] positioned ^ ^1 ^-6 facing entity @e[sort=nearest,limit=1,tag=um.salamander] eyes run tp ^ ^ ^6
...
execute as @e[sort=nearest,limit=1,tag=um.fireshot] at @s run tp ^ ^ ^1.2
