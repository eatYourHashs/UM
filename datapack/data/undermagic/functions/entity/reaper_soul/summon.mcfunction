...
execute if score $math.out_0 um.dummy matches 1..33 run summon armor_stand ^ ^1 ^4 {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["um.entity","global.ignore","um.healing_soul"]}
