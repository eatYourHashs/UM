...
execute if score temp um.dummy_two matches 10..12 at @p run summon armor_stand ~ ~ ~-6 {Invisible:1b,NoGravity:1b,Marker:1b,Tags:["global.ignore","um_disciple_of_death_move_marker"]}
