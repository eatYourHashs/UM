...
execute if score @s um.dummy matches 25 if score @s um.boss_hp matches ..200 run function undermagic:entity/disciple_of_death/death_scythe
execute if score @s um.dummy matches 30 if score @s um.boss_hp matches ..200 run function undermagic:entity/disciple_of_death/death_scythe
...
execute if score @s um.dummy matches 80 if score @s um.boss_hp matches ..200 at @s facing entity @p feet facing ^1 ^ ^6 run tp ^ ^ ^
execute if score @s um.dummy matches 80 if score @s um.boss_hp matches ..200 at @s run function undermagic:entity/disciple_of_death/death_scythe
execute if score @s um.dummy matches 80 if score @s um.boss_hp matches ..200 at @s facing entity @p feet facing ^2 ^ ^6 run tp ^ ^ ^
execute if score @s um.dummy matches 80 if score @s um.boss_hp matches ..200 at @s run function undermagic:entity/disciple_of_death/death_scythe
execute if score @s um.dummy matches 80 if score @s um.boss_hp matches ..200 at @s facing entity @p feet facing ^-1 ^ ^6 run tp ^ ^ ^
execute if score @s um.dummy matches 80 if score @s um.boss_hp matches ..200 at @s run function undermagic:entity/disciple_of_death/death_scythe
execute if score @s um.dummy matches 80 if score @s um.boss_hp matches ..200 at @s facing entity @p feet facing ^-2 ^ ^6 run tp ^ ^ ^
...
execute if score @s um.dummy matches 145 if score @s um.boss_hp matches ..200 run function undermagic:entity/disciple_of_death/death_scythe
execute if score @s um.dummy matches 150 if score @s um.boss_hp matches ..200 run function undermagic:entity/disciple_of_death/death_scythe
