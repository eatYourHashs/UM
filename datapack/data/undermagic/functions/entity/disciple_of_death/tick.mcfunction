...
execute facing entity @e[tag=um.disciple_of_death_move_marker,limit=1,sort=nearest] feet run tp ^ ^ ^1.5
execute if entity @e[tag=um.disciple_of_death_move_marker,distance=..2] run playsound minecraft:entity.enderman.teleport hostile @a ~ ~ ~ 1 2
kill @e[tag=um.disciple_of_death_move_marker,distance=..1,limit=1]
execute at @s facing entity @p feet run tp ^ ^ ^
execute store result score @s um.boss_hp run data get entity @s Health 1
execute if entity @e[tag=um.disciple_of_death_move_marker] if score @s um.dummy matches 20 run scoreboard players set @s um.dummy 10
execute if entity @e[tag=um.disciple_of_death_move_marker] if score @s um.dummy matches 80 run scoreboard players set @s um.dummy 70
execute if entity @e[tag=um.disciple_of_death_move_marker] if score @s um.dummy matches 140 run scoreboard players set @s um.dummy 130
execute if entity @e[tag=um.disciple_of_death_move_marker] if score @s um.dummy matches 200 run scoreboard players set @s um.dummy 199
...
execute if score @s um.dummy matches 180 as @e[tag=um.disciple_of_death_move_marker] at @s run tp @s ~ ~2 ~
