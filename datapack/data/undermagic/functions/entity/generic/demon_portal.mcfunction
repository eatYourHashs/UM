...
execute if score @s um.dummy matches 20.. if entity @p[distance=..24] if block ~ ~ ~ matches air if block ~ ~1 ~ matches air if block ~ ~2 ~ matches air run function undermagic:entity/generic/demon_spawn_processing
