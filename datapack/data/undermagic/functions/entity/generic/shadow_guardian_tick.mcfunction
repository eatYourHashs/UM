...
execute if entity @s[tag=um_shadow_guardian] as @e[tag=!global.ignore,scores={um.invuln=10..},tag=um_guardian_target,distance=..1] run function undermagic:utils/damage_entity
