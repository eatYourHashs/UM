...
execute if score @s um.dummy_two matches 200..400 if entity @e[type=#undermagic:hostile,distance=..3] run function undermagic:entity/wyrmling/wyrmling_fam_bite
