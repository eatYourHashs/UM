...
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 1..4 if entity @e[distance=..32,type=#undermagic:hostile,tag=!um_untargetable] run kill @e[tag=um_fam_marker]
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 5..9 if entity @e[distance=..48,type=#undermagic:hostile,tag=!um_untargetable] run kill @e[tag=um_fam_marker]
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 10 if entity @e[distance=..64,type=#undermagic:hostile,tag=!um_untargetable] run kill @e[tag=um_fam_marker]
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 1..4 if entity @e[distance=..32,type=#undermagic:hostile,tag=!um_untargetable] at @e[distance=..32,type=#undermagic:hostile,limit=1,sort=nearest,tag=!um_untargetable] run summon armor_stand ^-1.5 ^1 ^-1 {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 5..9 if entity @e[distance=..48,type=#undermagic:hostile,tag=!um_untargetable] at @e[distance=..48,type=#undermagic:hostile,limit=1,sort=nearest,tag=!um_untargetable] run summon armor_stand ^-1.5 ^1 ^-1 {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 10 if entity @e[distance=..64,type=#undermagic:hostile,tag=!um_untargetable] at @e[distance=..32,type=#undermagic:hostile,limit=1,sort=nearest,tag=!um_untargetable] run summon armor_stand ^-1.5 ^1 ^-1 {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score @s um.dummy_two matches 200..400 if entity @e[type=#undermagic:hostile,distance=..3,tag=!um_untargetable] run function undermagic:entity/wyrmling/wyrmling_fam_bite
execute if score temp2 um.dummy matches 4 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..32,tag=!um_untargetable] run kill @e[tag=um_fam_marker]
execute if score temp2 um.dummy matches 5..9 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..48,tag=!um_untargetable] run kill @e[tag=um_fam_marker]
execute if score temp2 um.dummy matches 10 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..64,tag=!um_untargetable] run kill @e[tag=um_fam_marker]
execute if score temp2 um.dummy matches 4 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..32,tag=!um_untargetable] run summon armor_stand ~ ~10 ~ {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score temp2 um.dummy matches 5..9 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..48,tag=!um_untargetable] run summon armor_stand ~ ~10 ~ {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score temp2 um.dummy matches 10 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..64,tag=!um_untargetable] run summon armor_stand ~ ~10 ~ {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score temp2 um.dummy matches 4 if score @s um.dummy_three matches ..1 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..32,tag=!um_untargetable] facing entity @e[limit=1,sort=nearest,type=#undermagic:hostile,tag=!um_untargetable] feet run function undermagic:entity/wyrmling/wyrmling_fam_fireball
execute if score temp2 um.dummy matches 5..9 if score @s um.dummy_three matches ..1 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..48,tag=!um_untargetable] facing entity @e[limit=1,sort=nearest,type=#undermagic:hostile,tag=!um_untargetable] feet run function undermagic:entity/wyrmling/wyrmling_fam_fireball
execute if score temp2 um.dummy matches 10 if score @s um.dummy_three matches ..1 if entity @e[limit=1,sort=nearest,type=#undermagic:hostile,distance=..64,tag=!um_untargetable] facing entity @e[limit=1,sort=nearest,type=#undermagic:hostile,tag=!um_untargetable] feet run function undermagic:entity/wyrmling/wyrmling_fam_fireball
