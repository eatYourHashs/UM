...
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 1..4 if entity @e[distance=..32,type=#undermagic:hostile,tag=!um_untargetable] at @e[distance=..32,type=#undermagic:hostile,limit=1,sort=nearest,tag=!um_untargetable] run summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 5..9 if entity @e[distance=..48,type=#undermagic:hostile,tag=!um_untargetable] at @e[distance=..48,type=#undermagic:hostile,limit=1,sort=nearest,tag=!um_untargetable] run summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 10 if entity @e[distance=..64,type=#undermagic:hostile,tag=!um_untargetable] at @e[distance=..64,type=#undermagic:hostile,limit=1,sort=nearest,tag=!um_untargetable] run summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
