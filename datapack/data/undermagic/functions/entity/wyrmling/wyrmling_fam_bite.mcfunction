...
#execute if score difficulty um.dummy matches 1.. run effect give @e[tag=um.pit_lord_boss,distance=..3.5,tag=!um.untargetable] resistance 1 3 true
#execute if score difficulty um.dummy matches 1.. run effect give @e[tag=um.blood_minion,distance=..3.5] resistance 1 2 true
#execute if score difficulty um.dummy matches 1.. run effect give @e[tag=um.elder_hand,distance=..3.5] resistance 1 3 true
#execute if score difficulty um.dummy matches 1.. run effect give @e[tag=um.elder_eye,distance=..3.5,tag=!um.untargetable] resistance 1 2 true
#execute if score difficulty um.dummy matches 1.. run effect give @e[tag=um.shadesull_elder_hand,distance=..3.5] resistance 1 2 true
#execute if score difficulty um.dummy matches 1.. run effect give @e[tag=um.shadesull,distance=..3.5,tag=!um.untargetable] resistance 1 3 true
...
execute as @e[type=#undermagic:hostile,sort=nearest,limit=1,type=!#undermagic:undead,distance=..3.5,tag=!um.untargetable] run function undermagic:utils/damage_entity
