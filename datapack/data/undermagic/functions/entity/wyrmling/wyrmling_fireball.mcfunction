...
execute as @e[sort=nearest,limit=1,tag=um.fireshot] positioned ^ ^1 ^-6 facing entity @e[sort=nearest,limit=1,tag=um.wyrmling] eyes run tp ^ ^ ^6
...
execute as @e[sort=nearest,limit=1,tag=um.fireshot] at @s run tp ^ ^ ^3
...
execute store result entity @e[sort=nearest,limit=1,tag=um.fireshot] power[0] double -0.005 run scoreboard players get x_delta um.dummy
execute store result entity @e[sort=nearest,limit=1,tag=um.fireshot] power[1] double -0.005 run scoreboard players get y_delta um.dummy
execute store result entity @e[sort=nearest,limit=1,tag=um.fireshot] power[2] double -0.005 run scoreboard players get z_delta um.dummy
