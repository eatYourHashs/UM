...
execute if score @s um.dummy matches 100 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^ ^ ^3 0.1 1 0.1 0 30
execute if score @s um.dummy matches 100 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^-3 ^ ^-1 0.1 1 0.1 0 30
execute if score @s um.dummy matches 100 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^3 ^ ^-1 0.1 1 0.1 0 30
execute if score @s um.dummy matches 100 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^ ^ ^3 {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 100 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^-3 ^ ^-1 {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 100 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^3 ^ ^-1 {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
...
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^ ^ ^ 0.1 1 0.1 0 30
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^2 ^ ^ 0.1 1 0.1 0 30
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^-2 ^ ^ 0.1 1 0.1 0 30
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^4 ^ ^ 0.1 1 0.1 0 30
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^-4 ^ ^ 0.1 1 0.1 0 30
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^ ^ ^ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^-2 ^ ^ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^-4 ^ ^ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^2 ^ ^ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 130 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^4 ^ ^ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
...
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^ ^ ^ 0.1 1 0.1 0 30
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^ ^ ^2 0.1 1 0.1 0 30
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^ ^ ^4 0.1 1 0.1 0 30
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^ ^ ^-2 0.1 1 0.1 0 30
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run particle smoke ^ ^ ^-4 0.1 1 0.1 0 30
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^ ^ ^ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^ ^ ^2 {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^ ^ ^4 {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^ ^ ^-2 {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
execute if score @s um.dummy matches 160 if score @s um.dummy_two matches 1 positioned as @p[distance=..40] run summon armor_stand ^ ^ ^-4 {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["global.ignore","um.entity","um.cataclyz_firestorm"]}
