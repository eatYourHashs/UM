...
execute if entity @s[tag=um.belch_acid] run function undermagic:entity/projectile/belch_acid_tick
...
execute if entity @s[tag=um.archdrake_special] run function undermagic:entity/projectile/archdrake_special_tick
