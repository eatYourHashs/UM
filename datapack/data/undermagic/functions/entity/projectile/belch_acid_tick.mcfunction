tp @s ^ ^ ^1
particle minecraft:dust 0.749 1 0 1 ~ ~ ~ 0.6 0.6 0.6 0 10
...
execute if score @s um.dummy matches 3.. as @e[tag=!global.ignore,scores={um.invuln=10..},distance=..2,tag=!um.blood_minion] run function undermagic:utils/damage_entity
execute if score @s um.dummy matches 3.. as @e[tag=!global.ignore,scores={um.invuln=10..},distance=..2] run function undermagic:entity/generic/corroded_apply
execute if score @s um.dummy matches 3.. run scoreboard players set $math.in_0 um.dummy 100
execute if score @s um.dummy matches 3.. run scoreboard players set $math.in_1 um.dummy 0
execute if score @s um.dummy matches 3.. run scoreboard players set $math.in_2 um.dummy 0
execute if score @s um.dummy matches 3.. run scoreboard players set $math.in_3 um.dummy 0
execute if score @s um.dummy matches 3.. as @e[tag=!global.ignore,scores={um.invuln=10..},distance=..2,tag=um.blood_minion] run function undermagic:utils/damage_entity
