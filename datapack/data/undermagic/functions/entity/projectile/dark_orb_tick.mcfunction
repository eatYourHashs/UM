...
execute if score @s um.dummy matches 3.. run scoreboard players set @e[distance=..2,tag=!global.ignore] um.aw_mark 20
execute if score @s um.dummy matches 3.. if entity @e[tag=!global.ignore,scores={um.invuln=10..},distance=..2] run kill @s
