...
execute if score @s um.dummy matches 10.. as @e[tag=!global.ignore,scores={um.invuln=10..},distance=..3,tag=!um_blood_minion] run function undermagic:utils/damage_entity
