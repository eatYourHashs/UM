...
execute if score @s um.boss_hp matches 151.. run function undermagic:entity/maxon/p1_tick
execute if score @s um.boss_hp matches ..150 run function undermagic:entity/maxon/p2_tick
