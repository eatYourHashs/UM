...
execute positioned ^ ^1 ^1 run tag @a[distance=..1] add um_shotgun_close
execute positioned ^ ^1 ^2 run tag @a[distance=..1.5] add um_shotgun_close
execute positioned ^ ^1 ^3 run tag @a[distance=..2] add um_shotgun_close
execute if score difficulty um.dummy matches 1.. positioned ^ ^1 ^4 run tag @a[distance=..3] add um_shotgun_close
execute positioned ^ ^1 ^4 run tag @a[distance=..2.5] add um_shotgun_far
execute positioned ^ ^1 ^5 run tag @a[distance=..3] add um_shotgun_far
execute positioned ^ ^1 ^6 run tag @a[distance=..3.5] add um_shotgun_far
execute if score difficulty um.dummy matches 1.. positioned ^ ^1 ^7 run tag @a[distance=..4] add um_shotgun_far
execute if score difficulty um.dummy matches 1.. positioned ^ ^1 ^8 run tag @a[distance=..4.5] add um_shotgun_far
execute if score difficulty um.dummy matches 1.. positioned ^ ^1 ^9 run tag @a[distance=..5] add um_shotgun_far
...
execute as @a[tag=!global.ignore,scores={um.invuln=10..},tag=um_shotgun_close] run function undermagic:utils/damage_entity
...
scoreboard players set $math.in_1 um.dummy 0
scoreboard players set $math.in_2 um.dummy 0
execute as @a[tag=!global.ignore,scores={um.invuln=10..},tag=um_shotgun_far] run function undermagic:utils/damage_entity