...
execute if entity @s[tag=um.dungeon_armory_marker] if entity @a[distance=..32] run function undermagic:world/dungeon_armory
...
execute if entity @s[tag=um.random_equip] if entity @a[distance=..16] run function undermagic:world/random_equip
