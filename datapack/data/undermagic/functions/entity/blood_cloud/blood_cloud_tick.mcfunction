...
execute if entity @s[tag=um.blood_cloud_1] run function undermagic:entity/blood_cloud/blood_cloud_1
execute if entity @s[tag=um.blood_cloud_2] run function undermagic:entity/blood_cloud/blood_cloud_2
execute if entity @s[tag=um.blood_cloud_3] run function undermagic:entity/blood_cloud/blood_cloud_3
