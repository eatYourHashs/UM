...
execute if score @s um.dummy_two matches 20.. run summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_blood_cloud","um_blood_drop_1"]}
