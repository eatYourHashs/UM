...
execute if score difficulty um.dummy matches 2.. if predicate undermagic:probability/0.01 at @e[sort=random,tag=um_crystal_marker,limit=1] unless entity @e[type=end_crystal,distance=..2] run function undermagic:entity/ender_dragon/respawn_crystal
