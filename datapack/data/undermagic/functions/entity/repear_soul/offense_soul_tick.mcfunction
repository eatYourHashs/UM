...
execute if entity @e[type=#undermagic:hostile,type=#undermagic:undead,distance=..2,tag=!global.ignore] unless score @s um.dummy matches 0..20 run effect give @e[sort=nearest,limit=1,type=#undermagic:hostile,type=#undermagic:undead,distance=..2,tag=!global.ignore] instant_health 1 2
execute if entity @e[type=#undermagic:hostile,type=!#undermagic:undead,distance=..2,tag=!global.ignore] unless score @s um.dummy matches 0..20 run effect give @e[sort=nearest,limit=1,type=#undermagic:hostile,type=!#undermagic:undead,distance=..2,tag=!global.ignore] instant_damage 1 2
