...
execute if score @s um.dummy_two matches 120 facing entity @p[distance=..20] feet run function undermagic:dark_orb_shadebeast
execute if score @s um.dummy_two matches 160 facing entity @p[distance=..20] feet run function undermagic:dark_orb_shadebeast
execute if score @s um.dummy_two matches 80 facing entity @p[distance=..20] feet run function undermagic:dark_orb_shadebeast
