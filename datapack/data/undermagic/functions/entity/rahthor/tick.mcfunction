...
execute if score @s um.boss_hp matches 101.. run function undermagic:entity/rahthor/p1_tick
execute if score @s um.boss_hp matches ..100 run function undermagic:entity/rahthor/p2_tick
