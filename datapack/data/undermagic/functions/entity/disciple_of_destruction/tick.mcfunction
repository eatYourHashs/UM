...
execute if score @s um.dummy matches 100 facing entity @p[distance=..16,gamemode=!spectator] feet run function undermagic:entity/disciple_of_destruction/disciple_of_destruction_blast
...
execute if score @s um.dummy matches 110 if score @s um.boss_hp matches ..200 facing entity @p[distance=..16,gamemode=!spectator] feet run function undermagic:entity/disciple_of_destruction/disciple_of_destruction_blast
...
execute if score @s um.dummy matches 120 if score @s um.boss_hp matches ..150 facing entity @p[distance=..16,gamemode=!spectator] feet run function undermagic:entity/disciple_of_destruction/disciple_of_destruction_blast
...
execute if score @s um.dummy matches 130 if score @s um.boss_hp matches ..100 facing entity @p[distance=..16,gamemode=!spectator] feet run function undermagic:entity/disciple_of_destruction/disciple_of_destruction_blast
...
execute if score @s um.dummy matches 140 if score @s um.boss_hp matches ..50 facing entity @p[distance=..16,gamemode=!spectator] feet run function undermagic:entity/disciple_of_destruction/disciple_of_destruction_blast
