...
execute if score @s um.dummy matches 100 facing entity @p[distance=..16,gamemode=!creative,gamemode=!spectator] feet run function undermagic:entity/greater_demon/greater_demon_fireshot
execute if score @s um.dummy matches 120 facing entity @p[distance=..16,gamemode=!creative,gamemode=!spectator] feet run function undermagic:entity/greater_demon/greater_demon_fireshot
execute if score @s um.dummy matches 140 facing entity @p[distance=..16,gamemode=!creative,gamemode=!spectator] feet run function undermagic:entity/greater_demon/greater_demon_fireshot
