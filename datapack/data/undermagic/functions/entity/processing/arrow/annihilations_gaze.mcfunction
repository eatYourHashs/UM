...
execute if score @s um.annih_draw matches 60.. run function undermagic:entity/projectile/annihilations_gaze_supercharge
execute unless score @s um.annih_draw matches 60.. run function undermagic:entity/projectile/annihilations_gaze
scoreboard players set @s um.annih_draw 0