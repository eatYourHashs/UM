...
scoreboard players add temp um.dummy 5
...
scoreboard players add temp um.dummy 10
...
execute store result score a um.dummy run data get entity @s Motion[0] 11000
execute store result score b um.dummy run data get entity @s Motion[1] 11000
execute store result score c um.dummy run data get entity @s Motion[2] 11000
