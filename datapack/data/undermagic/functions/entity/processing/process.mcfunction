...
execute if entity @s[type=zombified_piglin] if predicate undermagic:in_abyss run function undermagic:entity/processing/zombified_piglin
...
execute if entity @s[type=wither] run tag @s add um.entity
execute if entity @s[type=ender_dragon] if data entity @s DragonPhase run tag @s add um.entity
