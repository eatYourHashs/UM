...
execute if data entity @s Inventory[{Slot:-106b}].tag.um_id run function undermagic:player/check_offhand_item_interval
...
execute run loot give @s[scores={um.dragon_killed=1..}] loot undermagic:items/dragon_hide
execute run loot give @s[scores={um.wither_killed=1..}] loot undermagic:items/bone_of_wither
