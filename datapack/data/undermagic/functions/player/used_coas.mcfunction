...
execute if score $length um.dummy matches 15 if data entity @s SelectedItem.tag{um_id:"lashes_of_light"} run function undermagic:item/weapon/lashes_of_light/use
...
execute if score $length um.dummy matches 18 if score @s um.mana matches 7.. if data entity @s SelectedItem.tag{um_id:"blood_rain_staff_1"} positioned ~ ~1.8 ~ positioned ^ ^ ^3 run function undermagic:item/weapon/brs_1_cast
execute if score $length um.dummy matches 18 if score @s um.mana matches 6.. if data entity @s SelectedItem.tag{um_id:"blood_rain_staff_2"} positioned ~ ~1.8 ~ positioned ^ ^ ^3 run function undermagic:item/weapon/brs_2_cast
execute if score $length um.dummy matches 18 if score @s um.mana matches 5.. if data entity @s SelectedItem.tag{um_id:"blood_rain_staff_3"} positioned ~ ~1.8 ~ positioned ^ ^ ^3 run function undermagic:item/weapon/brs_3_cast
execute if score $length um.dummy matches 18 if score @s um.mana matches 4.. if data entity @s SelectedItem.tag{um_id:"blood_rain_staff_4"} positioned ~ ~1.8 ~ positioned ^ ^ ^3 run function undermagic:item/weapon/brs_4_cast
