...
execute if score $length um.dummy matches 12 if data entity @s SelectedItem.tag{um_id:"flare_runner"} unless score @s um.flare_cd matches 1.. run function undermagic:item/weapon/flare_runner_use
