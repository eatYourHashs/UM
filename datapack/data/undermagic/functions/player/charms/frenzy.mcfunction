...
execute if score temp0 um.dummy matches ..10 if score @s um.frenzy_charms matches 1 run attribute @s minecraft:generic.attack_damage modifier add 23520e02-f308-40f4-a919-5e03bd775fb2 frenzy1 0.2 multiply
execute if score temp0 um.dummy matches ..10 if score @s um.frenzy_charms matches 2 run attribute @s minecraft:generic.attack_damage modifier add 23520e02-f308-40f4-a919-5e03bd775fb2 frenzy1 0.3 multiply
execute if score temp0 um.dummy matches ..10 if score @s um.frenzy_charms matches 3 run attribute @s minecraft:generic.attack_damage modifier add 23520e02-f308-40f4-a919-5e03bd775fb2 frenzy1 0.4 multiply
execute if score temp0 um.dummy matches ..10 if score @s um.frenzy_charms matches 4.. run attribute @s minecraft:generic.attack_damage modifier add 23520e02-f308-40f4-a919-5e03bd775fb2 frenzy1 0.5 multiply
execute if score temp0 um.dummy matches ..10 if score @s um.frenzy_charms matches 1 run attribute @s minecraft:generic.movement_speed modifier add 121860d1-f4f0-4f0b-b7f5-9fbaf0ec1f3d frenzy2 0.2 multiply
execute if score temp0 um.dummy matches ..10 if score @s um.frenzy_charms matches 2 run attribute @s minecraft:generic.movement_speed modifier add 121860d1-f4f0-4f0b-b7f5-9fbaf0ec1f3d frenzy2 0.3 multiply
execute if score temp0 um.dummy matches ..10 if score @s um.frenzy_charms matches 3 run attribute @s minecraft:generic.movement_speed modifier add 121860d1-f4f0-4f0b-b7f5-9fbaf0ec1f3d frenzy2 0.4 multiply
execute if score temp0 um.dummy matches ..10 if score @s um.frenzy_charms matches 4.. run attribute @s minecraft:generic.movement_speed modifier add 121860d1-f4f0-4f0b-b7f5-9fbaf0ec1f3d frenzy2 0.5 multiply
