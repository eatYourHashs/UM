...
execute if score temp0 um.dummy matches 1..15 run effect give @p[scores={um.kinet_charms=1..},distance=..3] absorption 20 0
execute if score temp0 um.dummy matches 16..20 run effect give @p[scores={um.kinet_charms=2..},distance=..3] absorption 20 0
execute if score temp0 um.dummy matches 21..25 run effect give @p[scores={um.kinet_charms=3..},distance=..3] absorption 20 0
execute if score temp0 um.dummy matches 26..30 run effect give @p[scores={um.kinet_charms=4..},distance=..3] absorption 20 0
