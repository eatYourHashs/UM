...
scoreboard objectives add um.count_count dummy
scoreboard objectives add um.count_cd dummy
scoreboard objectives add um.lastst_time dummy
...
bossbar set undermagic:cataclyz max 400
