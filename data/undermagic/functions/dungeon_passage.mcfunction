...
execute unless score stop um.dummy matches 1 if score rand um.dummy matches 91..100 positioned ^ ^ ^9 unless entity @e[tag=um_dungeon_spawn,distance=..128] unless entity @e[tag=um_shadesull_arena] run function undermagic:entity/shadesull/shadesull_arena
