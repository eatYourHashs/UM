...
tellraw @s ["",{"text":"Click here to download it at The Data Pack Center.","color":"red","underlined":true,"clickEvent":{"action":"open_url","value":"https://datapackcenter.com/resources/undermagic-resource-pack.47/"}},{"text":" This message will only display once.","color":"gray","italic":true,"underlined":false}]
