...
execute if entity @s[tag=um_icebow_proc] as @p at @s run function undermagic:shoot_ice_bolt
...
execute if entity @s[tag=um_dragons_proc] if entity @p[scores={um.dragon_energy=60..}] run function undermagic:dragon_special
...
execute if entity @s[tag=um_oathbow_proc,nbt={crit:1b}] as @p at @s positioned ^ ^1.2 ^2.1 run function undermagic:oathbow
