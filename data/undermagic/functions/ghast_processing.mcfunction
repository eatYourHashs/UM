...
execute in minecraft:the_nether unless entity @s[tag=selected] unless entity @e[tag=um_featgen,distance=..150] run function undermagic:rift_init
execute in minecraft:the_nether if entity @s[tag=selected] unless entity @e[tag=um_featgen,distance=..150] run function undermagic:demon_tower_spawn
