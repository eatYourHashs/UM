...
execute positioned ~ ~0.7 ~ if score @s um.dummy matches 5.. run effect give @e[distance=..1,type=!#undermagic:undead] instant_damage 1 2
execute positioned ~ ~0.7 ~ if score @s um.dummy matches 5.. run effect give @e[distance=..1,type=#undermagic:undead] instant_health 1 2