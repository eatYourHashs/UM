...
execute unless block ~ ~1 ~ air unless block ~ ~-1 ~ cave_air positioned ~ ~ ~ run effect give @e[distance=..3,type=!#undermagic:undead] instant_damage 1 0 true
execute unless block ~ ~1 ~ air unless block ~ ~-1 ~ cave_air positioned ~ ~ ~ run effect give @e[distance=..3,type=#undermagic:undead] instant_health 1 0 true
