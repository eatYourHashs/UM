...
execute if score @s um.dummy matches 10.. run effect give @e[distance=..2,tag=!um_undead] instant_damage 1 1
execute if score @s um.dummy matches 10.. run effect give @e[distance=..2,tag=um_undead] instant_health 1 1
