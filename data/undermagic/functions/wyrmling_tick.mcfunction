...
execute unless entity @e[tag=um_wyrmling_target,distance=..100] if entity @p[distance=..100] run function undermagic:wyrmling_retarget
execute if entity @e[tag=um_wyrmling_target,distance=..1] run function undermagic:wyrmling_retarget
...
execute if entity @s[scores={um.dummy_two=560}] facing entity @p feet run function undermagic:wyrmling_fireball
...
execute if entity @s[scores={um.dummy_two=660..}] if entity @p[distance=..1] run function undermagic:wyrmling_bite
