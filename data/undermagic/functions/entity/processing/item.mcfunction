...
execute if data entity @s Item.tag{um_id:"netheric_book"} if block ~ ~-0.9 ~ crafting_table store success score temp du.dummy run function undermagic:undercrafter_init
