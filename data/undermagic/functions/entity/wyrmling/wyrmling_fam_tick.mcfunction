...
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 1..4 if entity @e[distance=..32,tag=um_hostile] run kill @e[tag=um_fam_marker]
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 5..9 if entity @e[distance=..48,tag=um_hostile] run kill @e[tag=um_fam_marker]
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 10 if entity @e[distance=..64,tag=um_hostile] run kill @e[tag=um_fam_marker]
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 1..4 if entity @e[distance=..32,tag=um_hostile] at @e[distance=..32,tag=um_hostile,limit=1,sort=nearest] run summon armor_stand ^-1.5 ^1 ^-1 {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 5..9 if entity @e[distance=..48,tag=um_hostile] at @e[distance=..48,tag=um_hostile,limit=1,sort=nearest] run summon armor_stand ^-1.5 ^1 ^-1 {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score @s um.dummy_two matches 200..400 if score temp2 um.dummy matches 10 if entity @e[distance=..64,tag=um_hostile] at @e[distance=..32,tag=um_hostile,limit=1,sort=nearest] run summon armor_stand ^-1.5 ^1 ^-1 {Marker:1b,Invisible:1b,NoGravity:1b,Tags:["global.ignore","um_entity","um_fam_marker"]}
execute if score @s um.dummy_two matches 200..400 if entity @e[tag=um_hostile,distance=..3] run function undermagic:wyrmling_fam_bite
execute if score temp2 um.dummy matches 4 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,tag=um_hostile,distance=..32] run kill @e[tag=um_fam_marker]
execute if score temp2 um.dummy matches 5..9 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,tag=um_hostile,distance=..48] run kill @e[tag=um_fam_marker]
execute if score temp2 um.dummy matches 10 if score @s um.dummy_three matches 1..30 if entity @e[limit=1,sort=nearest,tag=um_hostile,distance=..64] run kill @e[tag=um_fam_marker]
