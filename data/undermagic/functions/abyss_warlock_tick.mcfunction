...
execute if score interval um.dummy matches 8 as @e[tag=um_warlock_hand,distance=..4,sort=nearest] at @s facing entity @e[scores={um.aw_mark=1..},distance=..40,sort=nearest,limit=1] feet run tp @s
execute if score interval um.dummy matches 8 as @e[tag=um_warlock_hand,distance=..4,sort=nearest] at @s facing entity @e[scores={um.aw_mark=1..},distance=..40,sort=nearest,limit=1,tag=!item] feet run function undermagic:aw_hand_bolt