...
replaceitem entity @s weapon.mainhand carrot_on_a_stick{um_id:"longsword_shadow",display:{Name:"{\"text\":\"Shadow Longsword\",\"color\":\"yellow\",\"italic\":false}",Lore:["{\"text\":\"Use while sheathed to Quick Draw!\",\"color\":\"gray\",\"italic\":false}","{\"text\":\"Swap to offhand to sheath!\",\"color\":\"gray\",\"italic\":false}"]},Unbreakable:1b,CustomModelData:420069,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:9,Operation:0,UUID:[I;0,410066,0,806093],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-2.6,Operation:0,UUID:[I;0,218287,0,385426],Slot:"mainhand"}]}
