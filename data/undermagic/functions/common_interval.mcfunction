...
execute if score difficulty um.dummy matches 1.. run loot give @a[scores={um.dragon_killed=1..}] loot undermagic:items/dragons_wrath
loot give @a[scores={um.dragon_killed=1..}] loot undermagic:items/dragon_scale_8
execute if score difficulty um.dummy matches 2.. run loot give @a[scores={um.dragon_killed=1..}] loot undermagic:items/dragons_wrath
...
execute if score difficulty um.dummy matches 1.. run loot give @a[scores={um.wither_killed=1..}] loot undermagic:items/bone_of_wither
