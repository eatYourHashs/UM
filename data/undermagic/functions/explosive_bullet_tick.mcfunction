...
execute unless block ~ ~ ~ air unless block ~ ~ ~ cave_air if score @e[tag=um_shadesull,limit=1,sort=nearest] um.boss_hp matches ..400 run function undermagic:explosive_orb
