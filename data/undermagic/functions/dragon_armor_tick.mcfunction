execute unless entity @e[tag=um_dragon_wings,distance=..10] run playsound minecraft:entity.ender_dragon.flap player @a ~ ~ ~ 1 0.8
execute unless entity @e[tag=um_dragon_wings,distance=..10] run summon minecraft:armor_stand ~ ~ ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["global.ignore","um_entity","um_dragon_wings"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{Unbreakable:1b,CustomModelData:420090}}]}
execute if entity @s[nbt={OnGround:0b}] run scoreboard players add @s um.drag_animate 1
execute if score @s um.drag_animate matches 2 run replaceitem entity @e[tag=um_dragon_wings,distance=..10,sort=nearest,limit=1] armor.head minecraft:carrot_on_a_stick{CustomModelData:420090}
execute if score @s um.drag_animate matches 4 run replaceitem entity @e[tag=um_dragon_wings,distance=..10,sort=nearest,limit=1] armor.head minecraft:carrot_on_a_stick{CustomModelData:420091}
execute if score @s um.drag_animate matches 6 run replaceitem entity @e[tag=um_dragon_wings,distance=..10,sort=nearest,limit=1] armor.head minecraft:carrot_on_a_stick{CustomModelData:420092}
execute if score @s um.drag_animate matches 8 run replaceitem entity @e[tag=um_dragon_wings,distance=..10,sort=nearest,limit=1] armor.head minecraft:carrot_on_a_stick{CustomModelData:420091}
...
tp @e[tag=um_dragon_wings,distance=..10,sort=nearest,limit=1] @s
